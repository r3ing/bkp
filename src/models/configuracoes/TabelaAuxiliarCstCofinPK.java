...
/**
 * The primary key class for the tabela_auxiliar_cst_cofins database table.
 * 
 */
@Embeddable
public class TabelaAuxiliarCstCofinPK implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TabelaAuxiliarCstCofinPK other = (TabelaAuxiliarCstCofinPK) obj;
		if (checkDelete == null) {
	...
	public TabelaAuxiliarCstCofinPK() {
	}
}