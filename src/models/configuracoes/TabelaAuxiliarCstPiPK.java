...
/**
 * The primary key class for the tabela_auxiliar_cst_pis database table.
 * 
 */
@Embeddable
public class TabelaAuxiliarCstPiPK implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TabelaAuxiliarCstPiPK other = (TabelaAuxiliarCstPiPK) obj;
		if (checkDelete == null) {
