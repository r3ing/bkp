...
/**
 * The primary key class for the tabela_auxiliar_cst_ipi database table.
 * 
 */
@Embeddable
public class TabelaAuxiliarCstIpiPK implements Serializable 
{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TabelaAuxiliarCstIpiPK other = (TabelaAuxiliarCstIpiPK) obj;
		if (checkDelete == null) {
