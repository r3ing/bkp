...
/**
 * The primary key class for the caixa_banco database table.
 * 
 */
@Embeddable
public class CaixaBancoPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof CaixaBancoPK)) {
			return false;
		}
		CaixaBancoPK castOther = (CaixaBancoPK)other;
		return 
