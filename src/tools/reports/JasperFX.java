...
import controllers.utils.EmailController;
...
public class JasperFX {
    ...
    public void show(String title) {
        this.show(WIDTH, HEIGHT, null, Modality.NONE, StageStyle.DECORATED, title);
        this.title = title;
    }

    public void show(int width, int height, StageStyle style, String title) {
        this.show(width, height, null, Modality.NONE, style, title);
        this.title = title;
    }

    public void show(int width, int height, final Window owner, Modality modality, StageStyle style, String title) {
    	this.title = title;
        ...
        stage.setTitle("Eptus@M Report - " + title);
    ...
    public Scene createScene(Page page, int width, int height) {
        ...
        Button btnSave = new Button("Save", new FontAwesomeIconView(FontAwesomeIcon.SAVE));
        Button btnPrint = new Button("Print", new FontAwesomeIconView(FontAwesomeIcon.PRINT));
        Button btnSendEmail = new Button("Print", new FontAwesomeIconView(FontAwesomeIcon.ENVELOPE_ALT));
        
        btnPrint.setOnAction(ae -> printReport());
        btnSave.setOnAction(ae -> saveReport());
        btnSendEmail.setOnAction(ae -> sendEmail());
        ...
        btnSendEmail.setContentDisplay(ContentDisplay.GRAPHIC_ONLY);
        
        
        btnPrint.setTooltip(new Tooltip("Imprimir"));
        btnSave.setTooltip(new Tooltip("Guardar"));
        btnSendEmail.setTooltip(new Tooltip("Enviar por Email"));
        ...
        ToolBar hbxToolBar = new ToolBar(btnSave, btnPrint, btnSendEmail, new Separator(),
    ...
    private void sendEmail() {
    	...
    	File file = new File(DadosGlobais.folderAnexoEmail+title+" "+today+".pdf");
    	...
    	try {
			...
			stg = new Stage();
			Scene scene = new Scene(util.openWindow("/views/utils/viewMail.fxml", new EmailController(file)));
